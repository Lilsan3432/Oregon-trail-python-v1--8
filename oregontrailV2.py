...
print('--------------------------------------')
print('Instructions:')
print('Your goal is to travel from the east to Oregon (2000 miles) by Dec 31st.')
...
while player_move_distance < 2000 and food_num > 0 and health_num > 0 and month_num < 13:
    ...
    if choice == 'travel':
        ...
        print('[suicide]: ends the python script.')
    elif choice == 'quit':
        ...
        print('if ur username is meriwether lewis then the difficulty will be set to impossible and the year 1803')
    else:
...
if player_move_distance >= 2000:
    print('Congratulations! You have successfully arrived in Oregon and started a new life!')
